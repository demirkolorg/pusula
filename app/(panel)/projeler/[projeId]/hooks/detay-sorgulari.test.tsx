...
function ornekKart(p: Partial<ListeKartOzeti> = {}): ListeKartOzeti {
  return {
    ...
    tamamlandi_mi: p.tamamlandi_mi ?? false,
    tamamlanma_oneri_durumu: p.tamamlanma_oneri_durumu ?? "YOK",
    tamamlanma_oneren_id: p.tamamlanma_oneren_id ?? null,
    tamamlanma_oneren: p.tamamlanma_oneren ?? null,
    tamamlanma_oneri_zamani: p.tamamlanma_oneri_zamani ?? null,
    tamamlanma_red_sebebi: p.tamamlanma_red_sebebi ?? null,
